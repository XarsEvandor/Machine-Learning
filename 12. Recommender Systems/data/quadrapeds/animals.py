...
from lib import RandomSeed
from lib import CScreenLog
from lib import CFileStore
from lib.data import CCustomDataSet
from rx.statistics import CHistogramOfClasses

# =========================================================================================================================
class CQuadrapedsDataSet(CCustomDataSet):
  # Constructor
  def __init__(self, p_nSampleCount, p_nSeed=2021, p_bIsVerbose=False):
    super(CQuadrapedsDataSet, self).__init__()
    # ................................................................
    # // Fields \\
    self.Seed = p_nSeed
  ...
  def GenerateData(self):
    self.Log.Print("%% make animal run for %d objects, starting with self.Seed %d\n%%\n" % (self.SampleCount, self.Seed))
  ...
  ##/*		NOTE: this also needs a global called "self.Seed".
  ##/* 
  ...
  #	self.Seed = (MULT * self.Seed + INC) % MOD;  
  #	tmp = ABS( self.Seed / (float)MOD ) ;
  #	return(tmp * range + st);
  ...
  #def rand3(self):
	 # #self.Seed= (MULT *self.Seed + INC) %MOD;
	 # #return ( ABS(self.Seed/ (float)MOD ) * 3.0 + 1.0)

  #def rand4(self):
  #  #self.Seed= (MULT *self.Seed + INC) %MOD;
  #  #return ( ABS(self.Seed/ (float)MOD ) * 4.0 + 1.0)
...
if __name__ == "__main__":
  if (len(sys.argv)==3):
    print("usage: '%s <self.Seed> <# of objects>'\n", sys.argv[0])
